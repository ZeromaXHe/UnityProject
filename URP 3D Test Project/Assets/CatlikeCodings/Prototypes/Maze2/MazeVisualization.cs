...
namespace CatlikeCodings.Prototypes.Maze2
{
    ...
    /// Date: 2025-08-22 14:55:04
    [CreateAssetMenu]
    public class MazeVisualization : ScriptableObject
    {
        [SerializeField] private MazeCellObject deadEnd,
            straight,
            cornerClosed,
            cornerOpen,
            tJunctionClosed,
        ...
        public void Visualize(Maze maze, MazeCellObject[] cellObjects)
        {
            ...
            {
                var prefabWithRotation = GetPrefab(maze[i]);
                var instance = cellObjects[i] = prefabWithRotation.Item1.GetInstance();
